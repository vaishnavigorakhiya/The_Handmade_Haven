...
<div class="blog-page">
    ...
    <div class="blog-header">
        ...
        <span class="subscribe-label">Get our free monthly planner — subscribe below</span> --}}
    ...
    <section class="blog-posts">
        ...
        $posts = [
            ['flip'=>false, 'tag'=>'Traditional Craft',        
             'img'=>'kantha.jpeg',   'fallback'=>'https://feminisminindia.com/wp-content/uploads/2020/12/Kantha.jpg',
        ...
        <article class="post-row {{ $post['flip'] ? 'flipped' : '' }}">
            ...
            <div class="post-body">
                ...
                <h3>{{ $post['title'] }}</h3>
                <p>{{ $post['body'] }}</p>
                {{-- <a href="{{ route('blog.show', $post['slug']) }}" class="btn-read">Read More</a> --}}
            </div>
        </article>
        @endforeach
