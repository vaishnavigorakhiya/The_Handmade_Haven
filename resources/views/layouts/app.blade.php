...
<style>
  ...
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  .nav-logo {
    ...
    font-weight: 900; color: var(--dark); text-decoration: none;
  ...
  .nav-btn {
    padding: 8px 18px; border: 2.5px solid var(--dark); border-radius: 50px;
    background: transparent; font-family: 'Nunito', sans-serif;
    font-weight: 700; font-size: 0.9rem; cursor: pointer;
    transition: all 0.2s; color: var(--dark); text-decoration: none;
  ...
  /* ══ ALERTS ══ */
  .alert {
    padding: 14px 24px; border: 3px solid var(--dark);
    border-radius: 12px; margin: 20px 40px;
  ...
  /* ══ BUTTONS ══ */
  .btn-primary {
    padding: 16px 36px; background: var(--coral); color: white;
  ...
  .btn-secondary {
    padding: 16px 36px; background: var(--white); color: var(--dark);
    border: 3px solid var(--dark); border-radius: 50px;
    font-family: 'Nunito', sans-serif; font-size: 1rem; font-weight: 800;
    cursor: pointer; box-shadow: 5px 5px 0 var(--dark);
    transition: all 0.15s; text-decoration: none;
  ...
  .product-card {
    ...
    box-shadow: 6px 6px 0 var(--dark); transition: all 0.2s;
  }
  ...
  .product-badge {
    ...
    font-size: 0.72rem; font-weight: 800; box-shadow: 2px 2px 0 var(--dark);
  }
  ...
  .add-to-cart-btn {
    ...
    transition: all 0.15s; box-shadow: 3px 3px 0 var(--coral);
  ...
  .back-btn {
    ...
    border: 2.5px solid var(--dark); border-radius: 50px;
    font-family: 'Nunito', sans-serif; font-weight: 800; font-size: 0.9rem;
    cursor: pointer; box-shadow: 3px 3px 0 var(--dark);
    margin-bottom: 36px; transition: all 0.15s;
...
<footer>
  ...
  @guest
    <button class="footer-login-btn" onclick="openLoginModal()">
